...
export function useInputHandler({
  ...
  const commandSuggestions: CommandSuggestion[] = [
    ...
    { command: "/models", description: "Switch Nebius Model" },
...
Model Configuration:
  Edit ~/.nebius/models.json to add custom models (Claude, GPT, Gemini, etc.)
...
Temperature: ${lastError.payload.temperature}
Max Tokens: ${lastError.payload.max_tokens}
